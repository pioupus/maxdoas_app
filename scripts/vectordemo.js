...
if (select == 0){
	...
	VectorSolver.setConstraintVec(8e8);
    VectorSolver.setConstraintSrcOET(1e-19);
    VectorSolver.setConstraintSrcTikhonov(30.5);
	VectorSolver.setSADiagonalvalue(9.5);
	VectorSolver.setThermalTheshold(2800);
	VectorSolver.setSrcVal(16);
	timestep1 = 30;
	timestep2 = 30;
	exportpath="/home/arne/diplom/software/application/diplom_maxdoas/scripts/exports/2007_12_02_02_41/";
	dl = new TDirlistSIGIS("/home/arne/diplom/SIGISData/so2diff_300k/2007_12_02_02_41");
	AKArithmetic = 1;
	skippictures = 0;
	stopatseqence = 0;
    ...
    corridornumberlimit = 0.75;
    corridornumberStart = 0.25;

	SADiagSecond = 0.3;
	VecConstrainedSecond = 3e6;
}
if(select == 1){
	Filegroup = 2;
	SIGISSteps = 10;
	...
	VectorSolver.setImageSmoothValue(3);
    VectorSolver.setSrcSmoothValue(3);
	VectorSolver.setAPrioriVec(1,0);
	VectorSolver.setUseMedianAprioriFilter(false);
//	VectorSolver.setConstraintVec(1e8);
	VectorSolver.setConstraintVec(1e7);
	VectorSolver.setSADiagonalvalue(1e2);
    VectorSolver.setConstraintSrcOET(1e-19);
    VectorSolver.setConstraintSrcTikhonov(0.5);
	timestep1 = 10;
	timestep2 = 10;
	corrthreshold = 0.96;
	...
	stopatseqence = 4;
	SADiagSecond = 1e4;
	VecConstrainedSecond = 1e2;

    maxCorridorLengthEnd = 0.75;
    maxCorridorLengthStart = 0.9;

    corridornumberlimit = 1;
    corridornumberStart = 0.5;
}
if(select == 2){
	PixelSize = 1;
...
//	VectorSolver.setConstraintVec(1e5);
	...
	VectorSolver.setSrcVal(10);
	timestep1 = 15;
	timestep2 = 15;
	SADiagSecond = 0.00005;
	VecConstrainedSecond = 5;
    ...
    maxCorridorLengthEnd = 0.8;
    maxCorridorLengthStart = 0.9;

    corridornumberlimit = 1;
    corridornumberStart = 0.1;
}
if (select == 5){
	corrthreshold = 0.85;
	Filegroup = 5;
...
//	VectorSolver.setConstraintVec(1e8);
	...
	timestep2 = 5;
	corrthreshold = 0.96;
	exportpath="/home/arne/diplom/software/application/diplom_maxdoas/scripts/exports/2007_12_01_00_13/";
...
//				print("old: "+RetImgVectorField.getTime().toString());
			...
			//	}
				if(iteration == 0)
					emissionsrate.save(exportpath+leadingZero(3,Index+skippictures)+"emissionsrate0.txt");
				if(iteration == 1)
					emissionsrate.save(exportpath+leadingZero(3,Index+skippictures)+"emissionsrate1.txt");
